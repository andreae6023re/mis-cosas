...
self.addEventListener('message',e=>{if(e.data?.type==='NOTIFY')self.registration.showNotification(e.data.title||'Mis cosas',{body:e.data.body||'',tag:e.data.tag||'mis-cosas',icon:'./icons/icon-192.png'});});
